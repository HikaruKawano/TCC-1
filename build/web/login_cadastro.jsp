...
<div class="container" id="container">
	...
	<div class="form-container sign-up-container">
			...
			<input type="text" placeholder="Endereço" name="enderecoCliente" required />
			<input type="text" placeholder="Cidade" name="cidadeCliente" required />
                        <input type="text" placeholder="Estado" name="estadoCliente" required />
                        <input type="text" placeholder="Cep" name="cepCliente" required />
