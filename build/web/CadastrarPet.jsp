...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="CadastrarPet" method="post"> 
                    ...
                    <div class="input-box">
                     ...
                     <div class="input-box">
                        ...
                        <div class="input-box">
                        <label for="cores">Fotos do pet</label>
                        <<input type="file" id="id" accept="image/png,image/jpeg" accept="image/*" multiple="multiple">                                        
                    </div>
                      <div class="input-box">
