    ...
    <nav class="navbar col-12  navbar-expand-lg navbar-dark" style="z-index: 999;">
        <div class="container-fluid col-11 m-auto">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <% 
                 if(pessoa.getLogouPessoa() == "funcionario"){ 
              %>
      ...
      <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
        <div class="btn-group me-2" role="group" aria-label="First group">
          <button type="button" class="btn btn-todos btn-outline" id="todos" value="todos" id="botao " onclick="Click ('todos')">Todos</button>
           ...
           <!-- Modal -->
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">${pet.nomePet}</h5>
              ...
              %>
                  ...
                  %>
                  <button  class="btn btn-primary"><a href="login_cadastro.jsp">Adotar</a></button>
                  <%
                      }   
                   %>
                </div>
