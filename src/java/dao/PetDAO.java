...
public class PetDAO implements DAOGenerica {
    ...
    public void cadastrar(Object objeto) throws SQLException {
        ...
        try {
            ...
            stmt.setString(3, pet.getRacaPet());
            stmt.setString(4, pet.getIdadePet());
            stmt.setString(5, pet.getEspeciePet());
            stmt.setString(6, pet.getCoresPet());
            stmt.setString(7, pet.getSexoPet());
            stmt.setString(8, pet.getPortePet());
            stmt.setString(9, pet.getObservacoes());
            stmt.execute();
    ...
    public List<Object> listar() throws SQLException {
        ...
        try {
            ...
            rs = stmt.executeQuery();
            while (rs.next()) {
                Pet pet = new Pet(rs.getInt("idpet"), rs.getString("nomepet"), rs.getString("racapet"), rs.getString("idadepet"), rs.getString("especiepet"), rs.getString("corespet"), rs.getString("sexopet"), rs.getString("portepet"), rs.getString("observacoes"));
                lista.add(pet);               
            }
        } catch (SQLException ex) {
